...

{
  ...
  const mate = think(mateIn1, 'medium', 'claims-mate', { timeMs: 320, mistakeChance: 0, vouchers: held });
  ...
  const grab = think(freeQueen, 'medium', 'claims-grab', { timeMs: 320, mistakeChance: 0, vouchers: held });
